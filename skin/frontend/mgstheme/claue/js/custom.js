...
function showMenu2(el) {
	...
	mgsjQuery(window).load(function(){
		mgsjQuery("#mobile-menu-cat-72 > li > a").addClass("shop-submenu-all-level-style");
		mgsjQuery("#mobile-menu-cat-87 > li > a").addClass("shop-submenu-all-level-style");
		mgsjQuery("#mobile-menu-cat-99 > li > a").first().addClass("shop-submenu-all-level-style");
		mgsjQuery("#mobile-menu-2 ul > li").addClass("eeeeeeeeeeeeeeeeeeee");
